...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NormalizedSiteRelationship.depth'
        db.add_column(u'relationships_normalizedsiterelationship', 'depth',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NormalizedSiteRelationship.depth'
        db.delete_column(u'relationships_normalizedsiterelationship', 'depth')
