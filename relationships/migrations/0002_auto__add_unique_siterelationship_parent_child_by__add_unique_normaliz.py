...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'NormalizedSiteRelationship', fields ['parent', 'child', 'by']
        db.create_unique(u'relationships_normalizedsiterelationship', ['parent_id', 'child_id', 'by_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'NormalizedSiteRelationship', fields ['parent', 'child', 'by']
        db.delete_unique(u'relationships_normalizedsiterelationship', ['parent_id', 'child_id', 'by_id'])
    ...
    models = {
        ...
        u'relationships.normalizedsiterelationship': {
            'Meta': {'unique_together': "(('parent', 'child', 'by'),)", 'object_name': 'NormalizedSiteRelationship'},
