...
class TableContainer extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <Table pageChange={this.handlePageChange} currentPage={this.state.currentPage} handlePageSizeChange={this.handlePageSizeChange} pageSize={this.state.pageSize} tableData={tableData}>
