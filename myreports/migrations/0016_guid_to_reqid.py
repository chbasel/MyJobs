...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        columns = orm.ConfigurationColumn.objects.filter(column_name='job_guid')
        columns.update(column_name='reqid',
                       filter_interface_display='Requisition Id')

    def backwards(self, orm):
        columns = orm.ConfigurationColumn.objects.filter(column_name='reqid')
        columns.update(column_name='job_guid',
    ...
    complete_apps = ['myreports', 'myreports']
    symmetrical = True
