...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'SiteRelationship', fields ['by']
        db.create_index(u'seo_siterelationship', ['by'])

        # Adding index on 'SiteRelationship', fields ['child', 'by']
        db.create_index(u'seo_siterelationship', ['child_id', 'by'])

        # Adding index on 'SiteRelationship', fields ['parent', 'by']
        db.create_index(u'seo_siterelationship', ['parent_id', 'by'])


    def backwards(self, orm):
        # Removing index on 'SiteRelationship', fields ['parent', 'by']
        db.delete_index(u'seo_siterelationship', ['parent_id', 'by'])

        # Removing index on 'SiteRelationship', fields ['child', 'by']
        db.delete_index(u'seo_siterelationship', ['child_id', 'by'])

        # Removing index on 'SiteRelationship', fields ['by']
        db.delete_index(u'seo_siterelationship', ['by'])
    ...
    models = {
        ...
        u'seo.relationshipchoice': {
            'Meta': {'object_name': 'RelationshipChoice'},
        ...
        u'seo.seosite': {
            ...
            'related_children': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['seo.SeoSite']", 'through': u"orm['seo.SiteRelationship']", 'symmetrical': 'False'}),
        ...
        u'seo.siterelationship': {
            'Meta': {'unique_together': "(('parent', 'child', 'by'),)", 'object_name': 'SiteRelationship', 'index_together': "(('parent', 'by'), ('child', 'by'))"},
            'by': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_index': 'True'}),
            'child': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'parents'", 'to': u"orm['seo.SeoSite']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'children'", 'to': u"orm['seo.SeoSite']"}),
