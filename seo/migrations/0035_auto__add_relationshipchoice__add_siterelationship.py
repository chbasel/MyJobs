...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RelationshipChoice'
        db.create_table(u'seo_relationshipchoice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')()),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'seo', ['RelationshipChoice'])

        # Adding model 'SiteRelationship'
        db.create_table(u'seo_siterelationship', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('weight', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('by', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='child', to=orm['seo.SeoSite'])),
            ('child', self.gf('django.db.models.fields.related.ForeignKey')(related_name='parent', to=orm['seo.SeoSite'])),
        ))
        db.send_create_signal(u'seo', ['SiteRelationship'])


    def backwards(self, orm):
        # Deleting model 'RelationshipChoice'
        db.delete_table(u'seo_relationshipchoice')

        # Deleting model 'SiteRelationship'
        db.delete_table(u'seo_siterelationship')
    ...
    models = {
        ...
        u'seo.siterelationship': {
            ...
            'by': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'child': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'parent'", 'to': u"orm['seo.SeoSite']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'child'", 'to': u"orm['seo.SeoSite']"}),
