...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Configuration.browse_facet_show_5'
        db.add_column(u'seo_configuration', 'browse_facet_show_5',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Configuration.browse_facet_show_6'
        db.add_column(u'seo_configuration', 'browse_facet_show_6',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Configuration.browse_facet_text_5'
        db.add_column(u'seo_configuration', 'browse_facet_text_5',
                      self.gf('django.db.models.fields.CharField')(default='Job Profiles', max_length=50),
                      keep_default=False)

        # Adding field 'Configuration.browse_facet_text_6'
        db.add_column(u'seo_configuration', 'browse_facet_text_6',
                      self.gf('django.db.models.fields.CharField')(default='Job Profiles', max_length=50),
                      keep_default=False)

        # Adding field 'Configuration.browse_facet_order_5'
        db.add_column(u'seo_configuration', 'browse_facet_order_5',
                      self.gf('django.db.models.fields.IntegerField')(default=5),
                      keep_default=False)

        # Adding field 'Configuration.browse_facet_order_6'
        db.add_column(u'seo_configuration', 'browse_facet_order_6',
                      self.gf('django.db.models.fields.IntegerField')(default=6),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Configuration.browse_facet_show_5'
        db.delete_column(u'seo_configuration', 'browse_facet_show_5')

        # Deleting field 'Configuration.browse_facet_show_6'
        db.delete_column(u'seo_configuration', 'browse_facet_show_6')

        # Deleting field 'Configuration.browse_facet_text_5'
        db.delete_column(u'seo_configuration', 'browse_facet_text_5')

        # Deleting field 'Configuration.browse_facet_text_6'
        db.delete_column(u'seo_configuration', 'browse_facet_text_6')

        # Deleting field 'Configuration.browse_facet_order_5'
        db.delete_column(u'seo_configuration', 'browse_facet_order_5')

        # Deleting field 'Configuration.browse_facet_order_6'
        db.delete_column(u'seo_configuration', 'browse_facet_order_6')
    ...
    models = {
        ...
        u'seo.configuration': {
            ...
            'browse_facet_order_5': ('django.db.models.fields.IntegerField', [], {'default': '5'}),
            'browse_facet_order_6': ('django.db.models.fields.IntegerField', [], {'default': '6'}),
            ...
            'browse_facet_show_5': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'browse_facet_show_6': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'browse_facet_text_5': ('django.db.models.fields.CharField', [], {'default': "'Job Profiles'", 'max_length': '50'}),
            'browse_facet_text_6': ('django.db.models.fields.CharField', [], {'default': "'Job Profiles'", 'max_length': '50'}),
